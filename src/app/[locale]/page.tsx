  ...
  return (
    <section>
      <div>
        ...
        <div className="mt-10 sm:mt-5 text-center sm:text-left text-[2.1em] sm:text-[2em] md:text-[2.2em] 2xl:text-[2.8em] color-black dark:text-gray-200 text-lin cursor-default font-bold hero" id="hero-text">
