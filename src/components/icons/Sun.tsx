export default function SunIcon({ isDesktop, onClick }) {
    return (
        <svg onClick={onClick} height="25px" width="25px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" enableBackground="new 0 0 512 512">
            <g>
                <g>
